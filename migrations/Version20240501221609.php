 ...
 */
final class Version20240501221609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, user INT NOT NULL, montant DOUBLE PRECISION DEFAULT NULL, prix DOUBLE PRECISION DEFAULT NULL, datetime DATETIME DEFAULT NULL, username VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
